                        ...
                        <form action="{{ route('admin.user.create') }}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input id="password" class="form-control" name="password" type="text"
                                       placeholder="Пароль" minlength="8" value="{{ Str::random(10) }}">
                                <a class="text-secondary">Пароль должен быть длинной от 8 символов</a>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" id="admin" name="admin"
                                       type="checkbox">
                                <label class="form-check-label text-wrap" for="admin">Это администратор?
                                </label>
                            </div>
