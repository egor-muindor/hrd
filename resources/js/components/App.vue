            ...
            <form @submit="sendData" action="javascript:void(0);" method="get" class="container form">
                    ...
                    <div class="row">
                        <div class="col-12 col-md-8">
                            <div class="row">
                                <div class="col">
                                    <input
                                        class="input" id="main-information__surname" type="text"
                                    ...
                                    <input
                                        class="input input-name" id="main-information__name" type="text"
                                    ...
                                    <select
                                        class="sex" id="sex" name="sex" v-model="formData.candidateSex" required
                                ...
                                <div class="col">
                                    <input
                                        class="input input-name" id="main-information__patronymic" type="text"
                                        v-model="formData.candidatePatronymic"
                                        maxlength="255" name="main-information__patronymic" placeholder="Иванович"
                                    ...
                                    <input
                                        class="birth-date" id="birth-date" type="date"
                                    ...
                                    <input
                                        class="input input-birth-place" type="text"
                                        v-model="formData.candidateBirthplace" name="birth-place"
                                        maxlength="255" placeholder="г. Москва" required style="margin-top: 20px"
                                    >
                                    <div class="label-box">
                ...
                <section class="education">
                    ...
                    <table class="table table-responsive">
                        ...
                        <tr v-for="(entry, index) in tableDataEducation">
                            <td>
                                <input
                                    class="input" id="institution" type="text" name="institution"
                            ...
                            <td>
                                <input
                                    class="input" id="faculty" type="text" name="faculty" v-model="entry['faculty']"
                            ...
                            <td>
                                <input
                                    class="input" id="admission-year" type="text" min="1900" max="2099" step="1"
                            ...
                            <td>
                                <input
                                    class="input" type="text" min="1900" max="2099" step="1" name="graduation-year"
                                    maxlength="255" v-model="entry['graduationYear']" placeholder="2018" v-mask="'####'"
                                    required
                                >
                                <div class="label-box">
                            ...
                            <td>
                                <input
                                    class="input" id="graduation-course" type="number" min="1" max="7" step="1"
                            ...
                            <td>
                                <input
                                    class="input" id="specialty" type="text" name="specialty"
                            ...
                            <td>
                                <input
                                    class="input" id="diploma" type="text" name="diploma" v-mask="'###### #######'"
                            ...
                            <td class="col">
                                <button
                                    ...
                                    @click="deleteRow(tableDataEducation, index)"
                                >Удалить ряд
                                </button>
                            </td>
                        </tr>
                ...
                <section class="skills">
                    <div class="row">
                        <div class="col">
                            <input
                                class="input" id="languages" type="text" v-model="formData.candidateLanguages"
                        ...
                        <div class="col">
                            <input
                                class="input" id="science-degree" type="text"
                        ...
                        <div class="col">
                            <input
                                class="input" id="scientific-work" type="text"
                ...
                <section class="work-activity">
                    ...
                    <table class="table work-activity__table table-responsive">
                        ...
                        <tr v-for="(entry, index) in tableDataWork">
                            <td>
                                <input
                                    class="input" type="date" name="work-activity__entry" v-model="entry['entry']"
                            ...
                            <td>
                                <input
                                    class="input" type="date" name="work-activity__exit" v-model="entry['exit']"
                                    min="1900-01-01" max="2100-01-01"
                            ...
                            <td>
                                <input
                                    class="input" id="work-activity__position" type="text"
                            ...
                            <td>
                                <input
                                    class="input" id="work-activity__location" type="text"
                            ...
                            <td class="col">
                                <button
                                    class="btn btn-sm btn-danger" type="button"
                                    @click="deleteRow(tableDataWork, index)"
                                >Удалить ряд
                                </button>
                            </td>
                        </tr>
                ...
                <section class="stay-abroad">
                    ...
                    <table class="table stay-abroad__table table-responsive">
                        ...
                        <tr v-for="(entry, index) in tableDataAbroad">
                            <td>
                                <input
                                    class="input" type="date" name="work-activity__since-time"
                            ...
                            <td>
                                <input
                                    class="input" type="date" name="work-activity__at-time"
                            ...
                            <td>
                                <input
                                    class="input" id="work-activity__country" type="text"
                            ...
                            <td>
                                <input
                                    class="input" id="work-activity__goal" type="text" name="work-activity__goal"
                                    v-model="entry['goal']"
                            ...
                            <td class="col">
                                <button
                                    class="btn btn-sm btn-danger" type="button"
                                    @click="deleteRow(tableDataAbroad, index)"
                                >Удалить ряд
                                </button>
                            </td>
                        </tr>
                ...
                <section class="government-award">
                    ...
                    <table class="table government-award__table table-responsive">
                        ...
                        <tr v-for="(entry, index) in tableDataAward">
                            <td>
                                <input
                                    class="input" type="date" name="government-award__data" v-model="entry['data']"
                                    min="1900-01-01" max="2100-01-01"
                            ...
                            <td>
                                <input
                                    class="input" id="government-award__reward" type="text"
                                    name="government-award__reward"
                                    maxlength="255" v-model="entry['reward']" placeholder="Медаль, Почетная грамота"
                                    required
                                >
                                <div class="label-box">
                            ...
                            <td class="col">
                                <button
                                    class="btn btn-sm btn-danger" type="button"
                                    @click="deleteRow(tableDataAward, index)"
                                >Удалить ряд
                                </button>
                            </td>
                        </tr>
                ...
                <section class="military-duty" v-if="formData.candidateSex=='Муж'">
                    ...
                    <div class="row">
                        <div class="col">
                            <input
                                class="input" id="military-duty__rank" type="text"
                        ...
                        <div class="col">
                            <input
                                class="input" id="military-duty__composition" type="text"
                        ...
                        <div class="col">
                            <input
                                class="input" id="military-duty__branch" type="text"
                ...
                <section class="family-status">
                    ...
                    <table class="table table-responsive">
                        ...
                        <tr v-for="(entry, index) in tableDataFamily">
                            <td>
                                <input
                                    class="input" id="family-status__name" type="text" name="family-status__name"
                            ...
                            <td>
                                <input
                                    class="input" id="family-status__surname" type="text"
                            ...
                            <td>
                                <input
                                    class="input" id="family-status__patronymic" type="text"
                            ...
                            <td>
                                ...
                                <input
                                    class="input" id="family-status__birthday" type="date"
                            ...
                            <td>
                                <input
                                    class="input" id="family-status__telephone" type="tel"
                            ...
                            <td class="col">
                                <button
                                    class="btn btn-sm btn-danger" type="button"
                                    @click="deleteRow(tableDataFamily, index)"
                                >Удалить ряд
                                </button>
                            </td>
                        </tr>
                ...
                <section class="passport-data">
                    ...
                    <div class="row">
                        <div class="col">
                            <input
                                class="input" id="passport-data__passport-series" type="text"
                                v-model="formData.candidatePassportSeries"
                                maxlength="255" name="passport-data__passport-series" v-mask="'####'" placeholder="1111"
                                required
                            >
                            <div class="label-box">
                        ...
                        <div class="col">
                            <input
                                class="input" id="passport-data__passport-number" type="text"
                        ...
                        <div class="col">
                            <input
                                class="input" id="passport-data__passport-issued" type="text"
                                v-model="formData.candidatePassportGiven"
                                maxlength="255" name="passport-data__passport-issued"
                                placeholder="Отделом УФМС России по " required
                            >
                            <div class="label-box">
                ...
                <section class="additional-docs">
                    ...
                    <div class="row">
                        <div class="col">
                            <input
                                class="input" id="additional-docs__inn" type="text" v-model="formData.candidateInn"
                        ...
                        <div class="col">
                            <input
                                class="input" id="additional-docs__PFR" type="text" v-model="formData.candidatePfr"
                                name="additional-docs__PFR" v-mask="'###-###-###-##'" placeholder="111-111-111-11"
                                maxlength="255" required
                            >
                            <div class="label-box">
                                <label class="label" for="additional-docs__PFR">СНИЛС</label>
                            </div>
                        </div>
                    </div>
                </section>
                <section class="contact-information">
                    <div class="row">
                        <div class="col">
                            <input
                                class="input" id="contact-information__address" type="text"
                        ...
                        <div class="col">
                            <input
                                class="input" id="contact-information__telephone" type="tel"
                ...
                <section class="autobiography">
                    ...
                    <textarea
                        class="textarea autobiography__textarea" name="autobiography"
                ...
                <section class="government-award">
                    ...
                    <table class="table government-award__table table-responsive">
                        ...
                        <tr v-for="(entry, index) in tableFiles">
                            <td>
                                <input
                                    maxlength="255" class="form-control" type="text" v-model="entry['title']"
                                    placeholder="Название файла" required
                                >
                            </td>
                            <td>
                                <input
                                    class="form-control-file" type="file" :id="index"
                            ...
                            <td class="col">
                                <button
                                    class="btn btn-sm btn-danger" type="button"
                                    @click="deleteRow(tableFiles, index)"
                                >Удалить ряд
                                </button>
                            </td>
                        </tr>
...
export default {
    ...
    mounted () {
        this.tableDataEducation = [
            {
                institution: '', faculty: '', formStudy: '', admissionYear: '',
                graduationYear: '', graduationCourse: '', specialty: '', diploma: ''
            }
        ];
        this.tableDataWork = [
